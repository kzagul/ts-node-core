...
class TypeOfExcursionController implements IController{

    public async getAll(req: Request, res: Response, next: NextFunction){
        try {
            let sql: string = `SELECT * FROM typeofexcursion`
            let result = await db.query(sql)
            let typesOfVisiting: [TypeOfExcursionController] = result.rows;
...
let typeOfExcursion= new TypeOfExcursionController()
export { typeOfExcursion }